...
vi.mock('../../../server/db/index', () => ({ db: { insert: insertMock } }))
vi.mock('../../../server/db/schema', () => ({ files: { id: 'id', stored_name: 'stored_name' } }))

const { storeEncryptedFile, removeStoredFiles } = await import('../../../server/utils/store-encrypted-file')
